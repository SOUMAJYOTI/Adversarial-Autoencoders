        ...
        if train_model:
            ...
            for i in range(n_epochs):
                ...
                for b in range(1, n_batches + 1):
                    ...
                    batch_x, batch_y = next_batch_svhn(batch_size, x_l, y_l, )

                    batch_y_one_hot = convert_one_hot_encode(batch_y, 10)

                    sess.run(autoencoder_optimizer, feed_dict={x_input: batch_x, x_target: batch_x, y_input: batch_y_one_hot})
                    ...
                    if b % 5 == 0:
                        a_loss, d_loss, g_loss, summary = sess.run(
                            ...
                            feed_dict={x_input: batch_x, x_target: batch_x,
                                       real_distribution: z_real_dist, y_input: batch_y_one_hot})
